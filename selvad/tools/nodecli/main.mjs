...
const EventTypeMap = ['NONE', 'SELVA_SUB_UPDATE', 'SELVA_SUB_TRIGGER']
...
connect(PORT, HOST)
  .then(async (client) => {
    ...
    console.log(
      await client.cmd.modify(
        modify('ma00000000000001', [
          ['field', 'haha'],
          ['num', 13],
        ])
      )
    ...
    console.log(
      await client.cmd.objectGet(objectGet('', 'ma00000000000001', 'field'))
    )
    ...
    client.subscribe(0, (msg) => {
      ...
      const ev = deserialize(
        SelvaSubscriptions_PubsubMessage_def,
    ...
    await client.cmd.subscriptionsAdd(
      toSelvaProtoStrings(
    ...
    await client.cmd.subscriptionsRefresh(
      toSelvaProtoStrings(
        '2c35a5a4782b114c01c1ed600475532641423b1bf5bf26a6645637e989f79b61'
      )
    )
    ...
    console.log(
      await client.cmd.modify(
        modify('ma00000000000001', [['test', 'new field value']])
      )
    )

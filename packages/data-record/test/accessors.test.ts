...
describe('Test createReader error handling', () => {
	test('readValue() throws not found', () => {
		const buf = createRecord(compiled, obj)
		expect(() => readValue(compiled, buf, '.not_found')).toThrowError(
			/Not found/
		)
	})
	...
	test('readString() throws not found', () => {
		const buf = createRecord(compiled, obj)
		expect(() => readString(compiled, buf, '.not_found')).toThrowError(
			/Not found/
		)
	})
	...
	test('readString() throws not a string', () => {
		const buf = createRecord(compiled, obj)
		expect(() => readString(compiled, buf, '.a')).toThrowError(
			/Not a string/
		)
	})
	...
	test('writeValue() throws not found', () => {
		const buf = createRecord(compiled, obj)
		expect(() => writeValue(compiled, buf, '.not_found', 100)).toThrowError(
			/Not found/
		)
	})
	...
	test('writeValue() throws cannot write to a pointer', () => {
		const buf = createRecord(compiled, obj)
		expect(() => writeValue(compiled, buf, '.7', 100)).toThrowError(
			/Cannot write to a pointer/
		)
	})
	...
	test('writeString() throws not found', () => {
		const buf = createRecord(compiled, obj)
		expect(() =>
			writeString(compiled, buf, '.not_found', 'zyx')
		).toThrowError(/Not found/)
	})

	test('writeString() throws not a string', () => {
		const buf = createRecord(compiled, obj)
		expect(() => writeString(compiled, buf, '.a', 'zyx')).toThrowError(
			/Not a string/
		)
	})
	...
	test('createReader() throws not found', () => {
		const buf = createRecord(compiled, obj)
		expect(() => createReader(compiled, buf, '.not_found')).toThrowError(
			/Not found/
		)
	})
	...
	test('createStringReader() throws not found', () => {
		const buf = createRecord(compiled, obj)
		expect(() =>
			createStringReader(compiled, buf, '.not_found')
		).toThrowError(/Not found/)
	})

	test('createStringReader() throws not a string', () => {
		const buf = createRecord(compiled, obj)
		expect(() => createStringReader(compiled, buf, '.c')).toThrowError(
			/Not a string/
		)
	})
	...
	test('createWriter() throws not supported for cstring_p', () => {
		const buf = createRecord(compiled, obj)
		expect(() => createWriter(compiled, buf, '.7')).toThrowError(
			/not supported/
		)
	})
	...
	test('createWriter() throws not found', () => {
		const buf = createRecord(compiled, obj)
		expect(() => createWriter(compiled, buf, '.not_found')).toThrowError(
			/Not found/
		)
	})
})

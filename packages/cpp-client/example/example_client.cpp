...
class websocket_endpoint {
   public:
    ...
    int connect(std::string const& uri) {
        ...
        // if connection was succesful, advance connection id and create metadata for that
        // connection, and put it in the list of connections
        ...
        con->set_message_handler(websocketpp::lib::bind(
            &connection_metadata::on_message, metadata_ptr, websocketpp::lib::placeholders::_1,

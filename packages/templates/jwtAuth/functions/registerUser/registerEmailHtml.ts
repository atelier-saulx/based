...
<span class="preheader"
    style="display: none !important; visibility: hidden; mso-hide: all; font-size: 1px; line-height: 1px; max-height: 0; max-width: 0; opacity: 0; overflow: hidden;">Confirm your email address.</span>
            ...
            <table class="email-body_inner" align="center" width="570" cellpadding="0" cellspacing="0"
                ...
                <td class="content-cell"
                    ...
                    <h1
                        ...
                        align="center">Verify your email address.</h1>
                    ...
                    <p style="margin-top: 0; margin-bottom: 0; color: #333333; font-size: 15px; font-weight: 400; text-align: center;"
                        align="center">Please click the link bellow to verify your email address:</p>
                    ...
                    <table class="body-action" align="center" width="100%" cellpadding="0" cellspacing="0"
                        ...
                        <td align="center"
                            ...
                            <tr>
                                <td align="center"
                                style="word-break: break-word; font-family: &quot;Inter&quot;, Helvetica, Arial, sans-serif; font-size: 16px;">
                                <a href="${actionUrl}" class="f-fallback button" target="_blank"
                                    style="color: #FFF; border-color: #3d53e7; border-style: solid; border-width: 12px 50px; background-color: #3d53e7; display: inline-block; text-decoration: none; border-radius: 4px; -webkit-text-size-adjust: none; box-sizing: border-box;">Verify email address</a>
                                </td>
                            </tr>
                            </table>
                        </td>
                    ...
                    <table role="presentation" style="width: 100%;">
                        ...
                        <td
                            ...
                            align="center">Please ignore this email if you didn’t register.</p>
                        </td>
                        </tr>
                    </table>
                    </div>
...
export default registerEmailHtml

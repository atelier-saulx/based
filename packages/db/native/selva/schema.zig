...
pub fn getFieldSchemaByNode(ctx: *Db.DbCtx, node: Node.Node, field: u8) !FieldSchema {
...
pub fn getEdgeFieldSchema(db: *Db.DbCtx, edgeConstraint: EdgeFieldConstraint, field: u8) !FieldSchema {

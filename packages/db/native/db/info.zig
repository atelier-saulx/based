...
pub fn ofType(env: napi.c.napi_env, info: napi.c.napi_callback_info) callconv(.c) napi.c.napi_value {
    ...
    var arr: napi.c.napi_value = undefined;
    const status = napi.c.napi_create_array_with_length(env, 2, &arr);
    if (status != napi.c.napi_ok) {
        return null;
    }
...
pub fn nodeRangeHash(env: napi.c.napi_env, info: napi.c.napi_callback_info) callconv(.c) napi.c.napi_value {
    ...
    var ok: napi.c.napi_value = undefined;
    var nil: napi.c.napi_value = undefined;

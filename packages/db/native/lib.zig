...
export fn napi_register_module_v1(env: c.napi_env, exports: c.napi_value) c.napi_value {
    ...
    registerFunction(env, exports, "saveCommon", dump.save_common) catch return null;
    registerFunction(env, exports, "saveRange", dump.save_range) catch return null;
    registerFunction(env, exports, "loadCommon", dump.load_common) catch return null;
    registerFunction(env, exports, "loadRange", dump.load_range) catch return null;

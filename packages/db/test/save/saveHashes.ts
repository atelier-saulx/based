...
await test('small diff in schema 2', async (t) => {
  ...
  await db2.setSchema({
    types: {
      item: {
        title: 'string',
        ref1: { ref: 'item', prop: 'ref1' },
        ref2: { ref: 'item', prop: 'ref2' },
        ref3: { ref: 'item', prop: 'ref3' },
        ref4: { ref: 'item', prop: 'ref4' },
        ref5: { ref: 'item', prop: 'ref5' },
        ref6: { ref: 'item', prop: 'ref6' },
        ref7: { ref: 'item', prop: 'ref7' },
        ref8: { ref: 'item', prop: 'ref8' },
      },
    },
  })

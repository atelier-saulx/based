...
import { BasedDb, stringCompress as compress } from '../../src/index.ts'
import test from '../shared/test.ts'
import { equal, deepEqual } from '../shared/assert.ts'
import { italy, sentence, readBible } from '../shared/examples.ts'

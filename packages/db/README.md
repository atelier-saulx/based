...
Use edges and references to model complex relationships in your schema.

### Enum

Enums define strict, typed sets of values for certain fields.

### Expiration

Use the 'expire' property for automatically removing records after a certain time.
...
When a record’s expiration is reached, it’s safely removed from the database.

### Vector

Use vector properties to store and query arrays of floating-point values. For example:
...
This lets you quickly filter and search high-dimensional data using built-in vector operations.
...
BasedDb is a versatile and powerful database solution that supports a wide range of features and data types. Use this documentation to get started and explore the advanced capabilities of BasedDb.

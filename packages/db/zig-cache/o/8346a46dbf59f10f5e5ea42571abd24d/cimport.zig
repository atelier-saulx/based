...
pub const __INTMAX_C_SUFFIX__ = @compileError("unable to translate macro: undefined identifier `L`"); // (no file):94:9
pub const __UINTMAX_C_SUFFIX__ = @compileError("unable to translate macro: undefined identifier `UL`"); // (no file):100:9
pub const __INT64_C_SUFFIX__ = @compileError("unable to translate macro: undefined identifier `LL`"); // (no file):196:9
pub const __UINT32_C_SUFFIX__ = @compileError("unable to translate macro: undefined identifier `U`"); // (no file):218:9
pub const __UINT64_C_SUFFIX__ = @compileError("unable to translate macro: undefined identifier `ULL`"); // (no file):226:9
pub const __USER_LABEL_PREFIX__ = @compileError("unable to translate macro: undefined identifier `_`"); // (no file):317:9
...
pub const offsetof = @compileError("unable to translate C expr: unexpected token 'an identifier'"); // /Users/jimdebeer/zig/lib/include/stddef.h:116:9
...
pub const NAPI_EXTERN = @compileError("unable to translate macro: undefined identifier `visibility`"); // /Users/jimdebeer/saulx/based-db/packages/db/deps/node-v20.11.1/include/node/js_native_api.h:36:9
pub const NAPI_MODULE_EXPORT = @compileError("unable to translate macro: undefined identifier `visibility`"); // /Users/jimdebeer/saulx/based-db/packages/db/deps/node-v20.11.1/include/node/node_api.h:24:9
pub const NAPI_NO_RETURN = @compileError("unable to translate macro: undefined identifier `noreturn`"); // /Users/jimdebeer/saulx/based-db/packages/db/deps/node-v20.11.1/include/node/node_api.h:29:9
pub const NAPI_MODULE_INITIALIZER_X_HELPER = @compileError("unable to translate C expr: unexpected token '##'"); // /Users/jimdebeer/saulx/based-db/packages/db/deps/node-v20.11.1/include/node/node_api.h:55:9
pub const NAPI_MODULE_INITIALIZER_BASE = @compileError("unable to translate macro: undefined identifier `napi_register_module_v`"); // /Users/jimdebeer/saulx/based-db/packages/db/deps/node-v20.11.1/include/node/node_api.h:60:9
pub const NODE_API_MODULE_GET_API_VERSION_BASE = @compileError("unable to translate macro: undefined identifier `node_api_module_get_api_version_v`"); // /Users/jimdebeer/saulx/based-db/packages/db/deps/node-v20.11.1/include/node/node_api.h:63:9
pub const NAPI_MODULE_INIT = @compileError("unable to translate macro: undefined identifier `env`"); // /Users/jimdebeer/saulx/based-db/packages/db/deps/node-v20.11.1/include/node/node_api.h:72:9
pub const NAPI_MODULE = @compileError("unable to translate macro: undefined identifier `env`"); // /Users/jimdebeer/saulx/based-db/packages/db/deps/node-v20.11.1/include/node/node_api.h:82:9

...
pub const NAPI_EXTERN = @compileError("unable to translate macro: undefined identifier `visibility`"); // /Users/jimdebeer/saulx/based/packages/lmdb/deps/node-v20.11.1/include/node/js_native_api.h:36:9
pub const NAPI_MODULE_EXPORT = @compileError("unable to translate macro: undefined identifier `visibility`"); // /Users/jimdebeer/saulx/based/packages/lmdb/deps/node-v20.11.1/include/node/node_api.h:24:9
pub const NAPI_NO_RETURN = @compileError("unable to translate macro: undefined identifier `noreturn`"); // /Users/jimdebeer/saulx/based/packages/lmdb/deps/node-v20.11.1/include/node/node_api.h:29:9
pub const NAPI_MODULE_INITIALIZER_X_HELPER = @compileError("unable to translate C expr: unexpected token '##'"); // /Users/jimdebeer/saulx/based/packages/lmdb/deps/node-v20.11.1/include/node/node_api.h:55:9
pub const NAPI_MODULE_INITIALIZER_BASE = @compileError("unable to translate macro: undefined identifier `napi_register_module_v`"); // /Users/jimdebeer/saulx/based/packages/lmdb/deps/node-v20.11.1/include/node/node_api.h:60:9
pub const NODE_API_MODULE_GET_API_VERSION_BASE = @compileError("unable to translate macro: undefined identifier `node_api_module_get_api_version_v`"); // /Users/jimdebeer/saulx/based/packages/lmdb/deps/node-v20.11.1/include/node/node_api.h:63:9
pub const NAPI_MODULE_INIT = @compileError("unable to translate macro: undefined identifier `env`"); // /Users/jimdebeer/saulx/based/packages/lmdb/deps/node-v20.11.1/include/node/node_api.h:72:9
pub const NAPI_MODULE = @compileError("unable to translate macro: undefined identifier `env`"); // /Users/jimdebeer/saulx/based/packages/lmdb/deps/node-v20.11.1/include/node/node_api.h:82:9

...
export const markDefaults = (ctx: Ctx, def: LeafDef, val: any) => {
  if (ctx.operation === CREATE) {
    console.warn('TODO: markDefaults')
    // if (ctx.typeDef.hasSeperateDefaults && val !== null) {
...
export const markTextValue = (
  ...
  if (ctx.operation === CREATE) {
    console.warn('TODO: markTextValue')

...
test('[query] path extractor with static value and multiple required parameters (1 or more)', async (t: T) => {
  ...
  const r5 = await (await fetch(t.context.http + '/static/fafa/fefe/fifi/fofo/fufu/fafa/fefe/fifi/fofo/fufu')).json()
  const r6 = await (await fetch(t.context.http + '/static/fafa/fefe/fifi/fofo/fufu/fafa/fefe/fifi/fofo/fufu/')).json()
  ...
  const r10 = await (await fetch(t.context.http + '/bla/static/fafa/123/')).json()
  const r11 = await (await fetch(t.context.http + '/bla/static/fafa/fefe/fifi/fofo/fufu/fafa/fefe/fifi/fofo/fufu')).json()
  const r12 = await (await fetch(t.context.http + '/bla/static/fafa/fefe/fifi/fofo/fufu/fafa/fefe/fifi/fofo/fufu/')).json()
  const r13 = await (await fetch(t.context.http + '/bla/static/fafa/fefe/fifi/fofo/fufu/fafa/fefe/fifi/fofo/fufu/?token=123')).json()
  const r14 = await (await fetch(t.context.http + '/bla/static/fafa/fefe/?extra=abc&outro=123')).json()
  ...
  t.deepEqual(r5, { parameter: ['fafa','fefe','fifi','fofo','fufu','fafa','fefe','fifi','fofo','fufu'] })
  t.deepEqual(r6, { parameter: ['fafa','fefe','fifi','fofo','fufu','fafa','fefe','fifi','fofo','fufu'] })
  ...
  t.deepEqual(r11, { parameter: ['fafa','fefe','fifi','fofo','fufu','fafa','fefe','fifi','fofo','fufu'] })
  t.deepEqual(r12, { parameter: ['fafa','fefe','fifi','fofo','fufu','fafa','fefe','fifi','fofo','fufu'] })
  t.deepEqual(r13, { parameter: ['fafa','fefe','fifi','fofo','fufu','fafa','fefe','fifi','fofo','fufu'] })
...
test('[query] path extractor with static value and multiple optional parameters (0 or more)', async (t: T) => {
  ...
  const r18 = await (await fetch(t.context.http + '/bla/static/fafa/fefe/?extra=abc&outro=123')).json()
  ...
  t.deepEqual(r7, { parameter: ['fafa','fefe','fifi','fofo','fufu','fafa','fefe','fifi','fofo','fufu'] })
  t.deepEqual(r8, { parameter: ['fafa','fefe','fifi','fofo','fufu','fafa','fefe','fifi','fofo','fufu'] })
  t.deepEqual(r9, { parameter: [] })
  t.deepEqual(r10, { parameter: [] })
  t.deepEqual(r11, { parameter: ['fafa'] })
  t.deepEqual(r12, { parameter: ['fafa'] })
  ...
  t.deepEqual(r15, { parameter: ['fafa','fefe','fifi','fofo','fufu','fafa','fefe','fifi','fofo','fufu'] })
  t.deepEqual(r16, { parameter: ['fafa','fefe','fifi','fofo','fufu','fafa','fefe','fifi','fofo','fufu'] })
  t.deepEqual(r17, { parameter: ['fafa','fefe','fifi','fofo','fufu','fafa','fefe','fifi','fofo','fufu'] })
...
test('[query] path extractor with no static value and a optional parameter', async (t: T) => {
  ...
  const r14 = await (await fetch(t.context.http + '/?extra=abc&outro=123')).json()
...
test('[function] path matcher with static value and multiple required parameters (1 or more)', async (t: T) => {
  ...
  t.deepEqual(r11, { parameter: ['fafa','fefe','fifi','fofo','fufu','fafa','fefe','fifi','fofo','fufu'] })
  t.deepEqual(r12, { parameter: ['fafa','fefe','fifi','fofo','fufu','fafa','fefe','fifi','fofo','fufu'] })
  t.deepEqual(r13, { parameter: ['fafa','fefe','fifi','fofo','fufu','fafa','fefe','fifi','fofo','fufu'], token: '123' })
  t.deepEqual(r14, { parameter: ['fafa','fefe'], extra: 'abc', outro: '123' })
})
...
test('[function] path matcher with static value and multiple optional parameters (0 or more)', async (t: T) => {
  ...
  t.deepEqual(r15, { parameter: ['fafa','fefe','fifi','fofo','fufu','fafa','fefe','fifi','fofo','fufu'] })
  t.deepEqual(r16, { parameter: ['fafa','fefe','fifi','fofo','fufu','fafa','fefe','fifi','fofo','fufu'] })
  t.deepEqual(r17, { parameter: ['fafa','fefe','fifi','fofo','fufu','fafa','fefe','fifi','fofo','fufu'], token: '123' })
  t.deepEqual(r18, { parameter: ['fafa','fefe'], extra: 'abc', outro: '123' })
})

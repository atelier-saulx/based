...
import { BasedFunctionClient } from '../../../functions/client.js'
import {
  isClientContext,
  isWsContext,
  type AuthState,
  type Context,
  type InternalSessionClient,
  type Session,
  type StreamFunctionOpts,
} from '../../../functions/index.js'

export class BasedServerFunctionClient extends BasedFunctionClient {

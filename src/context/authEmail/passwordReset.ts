...
<body
  ...
  <span class="preheader"
    style="display: none !important; visibility: hidden; mso-hide: all; font-size: 1px; line-height: 1px; max-height: 0; max-width: 0; opacity: 0; overflow: hidden;">Password reset request from ${appName}.</span>
                  ...
                  <td class="content-cell"
                    ...
                    <div class="f-fallback">
                      ...
                      <h2
                        ...
                        align="left">Password reset request</h2>
                      ...
                      <p style="margin-top: 0; color: #09090B99; font-size: 14px; font-weight: 400; text-align: left;"
                        align="left">To reset your password, please click the button below:</p>
                        ...
                        <tr>
                          <td
                            ...
                            <p class="f-fallback sub"
                              ...
                              align="left">Please ignore this email if you didn’t request a password reset for this application.</p>
                          </td>
                        </tr>
                      </table>
                    </div>

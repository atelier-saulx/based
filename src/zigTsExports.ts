...
export const QueryIteratorTypeInverse = {
  ...
  40: 'edgeIncludeFilterOnEdge',
  41: 'edgeIncludeFilterOnEdgeDesc',
  42: 'edgeIncludeFilterOnEdgeSort',
  43: 'edgeIncludeFilterOnEdgeSortDesc',
  60: 'edgeFilterOnEdge',
  61: 'edgeFilterOnEdgeDesc',
  62: 'edgeFilterOnEdgeSort',
  63: 'edgeFilterOnEdgeSortDesc',
  70: 'edgeIncludeFilterAndFilterOnEdge',
  71: 'edgeIncludeFilterAndFilterOnEdgeDesc',
  72: 'edgeIncludeFilterAndFilterOnEdgeSort',
  73: 'edgeIncludeFilterAndFilterOnEdgeSortDesc',
  80: 'edgeFilterAndFilterOnEdge',
  81: 'edgeFilterAndFilterOnEdgeDesc',
  82: 'edgeFilterAndFilterOnEdgeSort',
  83: 'edgeFilterAndFilterOnEdgeSortDesc',
  120: 'search',
  121: 'searchFilter',
  130: 'vec',
  131: 'vecFilter',
...
/**
  ...
  edgeIncludeFilterAndFilterOnEdgeDesc, 
  edgeIncludeFilterAndFilterOnEdgeSort, 
  edgeIncludeFilterAndFilterOnEdgeSortDesc, 
  edgeFilterAndFilterOnEdge, 
  edgeFilterAndFilterOnEdgeDesc, 
...
export const writeAggHeader = (
  ...
  offset += 2
  buf[offset] = 0
  buf[offset] |= ((header.groupByCount >>> 0) & 15) << 0
  buf[offset] |= (((header.isSamplingSet ? 1 : 0) >>> 0) & 1) << 4
  buf[offset] |= ((0 >>> 0) & 7) << 5
  offset += 1
  return offset
}
...
export const writeAggHeaderProps = {
  ...
  groupByCount: (buf: Uint8Array, value: number, offset: number) => {
    buf[offset + 18] |= ((value >>> 0) & 15) << 0
  },
  isSamplingSet: (buf: Uint8Array, value: boolean, offset: number) => {
    buf[offset + 18] |= (((value ? 1 : 0) >>> 0) & 1) << 4
  },
}
...
export const readAggHeader = (
  ...
  const value: AggHeader = {
    ...
    groupByCount: ((buf[offset + 18] >>> 0) & 15),
    isSamplingSet: (((buf[offset + 18] >>> 4) & 1)) === 1,
  }
  return value
}
...
export const readAggHeaderProps = {
    ...
    groupByCount: (buf: Uint8Array, offset: number) => ((buf[offset + 18] >>> 0) & 15),
    isSamplingSet: (buf: Uint8Array, offset: number) => (((buf[offset + 18] >>> 4) & 1)) === 1,
}
...
export const pushAggHeader = (
  ...
  buf.pushUint8(0)
  buf.view[buf.length - 1] |= ((header.groupByCount >>> 0) & 15) << 0
  buf.view[buf.length - 1] |= (((header.isSamplingSet ? 1 : 0) >>> 0) & 1) << 4
  buf.view[buf.length - 1] |= ((0 >>> 0) & 7) << 5
  return index
}
...
export const writeAggRefsHeaderProps = {
  ...
  groupByCount: (buf: Uint8Array, value: number, offset: number) => {
    buf[offset + 15] |= ((value >>> 0) & 15) << 0
  },
  isSamplingSet: (buf: Uint8Array, value: boolean, offset: number) => {
    buf[offset + 15] |= (((value ? 1 : 0) >>> 0) & 1) << 4
  },
}
...
export const readAggRefsHeader = (
  ...
  const value: AggRefsHeader = {
    ...
    groupByCount: ((buf[offset + 15] >>> 0) & 15),
    isSamplingSet: (((buf[offset + 15] >>> 4) & 1)) === 1,
  }
  return value
}
...
export const readAggRefsHeaderProps = {
    ...
    groupByCount: (buf: Uint8Array, offset: number) => ((buf[offset + 15] >>> 0) & 15),
    isSamplingSet: (buf: Uint8Array, offset: number) => (((buf[offset + 15] >>> 4) & 1)) === 1,
}
...
export const SelvaSchemaAliasByteSize = 1

export const SelvaSchemaAliasAlignOf = 1

export const packSelvaSchemaAlias = (obj: SelvaSchemaAlias): number => {
  let val = 0
  val |= (Number(obj.type) & 255) << 0
  return val
}

export const unpackSelvaSchemaAlias = (val: number): SelvaSchemaAlias => {
  return {
    type: Number((val >>> 0) & 255),
  }
}
